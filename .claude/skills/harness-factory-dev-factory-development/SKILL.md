---
name: "harness-factory-dev-factory-development"
description: "Execute the domain workflow for Harness Factory development."
---

# harness-factory-dev-factory-development

Read `harness/harness-spec.json` first. Find `harness-factory-dev-factory-development` in `skills` and confirm its kind, entry agent, domains, instructions, and evaluator.

- kind: `domain`
- entry agent: `factory-builder`
- domains: factory-development
- evaluator: `factory-contract-tests`

Implement runtime-neutral factory changes in the declared source areas, update common contracts before projections, and hand raw checks to the evidence runner.
