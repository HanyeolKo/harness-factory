---
name: "harness-factory-dev-verify"
description: "Execute the verification workflow for Harness Factory development."
---

# harness-factory-dev-verify

Read `harness/harness-spec.json` first. Find `harness-factory-dev-verify` in `skills` and confirm its kind, entry agent, domains, instructions, and evaluator.

- kind: `verification`
- entry agent: `evidence-runner`
- domains: factory-development
- evaluator: `factory-contract-tests`

Run structural validation, provider parity, instruction and memory budgets, and cold-start checks without changing canonical meaning.
